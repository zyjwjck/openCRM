...
<svelte:head>
  <title>{t('accounts')} - openCRM</title>
</svelte:head>

<PageHeader title={t('accounts')} subtitle="{filteredAccounts.length} of {accounts.length} {t('accounts')}">
  {#snippet actions()}
...
<div class="flex-1">
  ...
  {#if filteredAccounts.length === 0}
    <div class="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 class="text-[var(--text-primary)] text-lg font-medium">{t('noAccountsFound')}</h3>
...
<CrmDrawer
  ...
  titleKey="name"
  titlePlaceholder={t('accountName')}
    ...
    {#if isClosed && drawerMode !== 'create'}
      ...
      >
        <div class="flex gap-2">
          ...
          <div>
            <p class="text-sm font-medium text-[var(--color-negative-default)]">{t('thisAccountIsClosed')}</p>
            <p class="mt-0.5 text-xs text-[var(--color-negative-default)]/80">
              {t('reopenAccountToMakeChanges')}
            </p>
          </div>
        </div>
      </div>
    ...
    {#if drawerMode !== 'create' && selectedAccount}
      <div class="mb-4">
        ...
        <div class="grid grid-cols-4 gap-2">
          <div class="rounded-[var(--radius-lg)] bg-[var(--surface-sunken)] p-2 text-center">
            ...
            <p class="text-[10px] text-[var(--text-secondary)]">{t('contacts')}</p>
          </div>
          <div class="rounded-[var(--radius-lg)] bg-[var(--surface-sunken)] p-2 text-center">
            <div class="flex items-center justify-center gap-1 text-[var(--text-tertiary)]">
            ...
            <p class="text-[10px] text-[var(--text-secondary)]">{t('opportunities')}</p>
          </div>
          <div class="rounded-[var(--radius-lg)] bg-[var(--surface-sunken)] p-2 text-center">
            <div class="flex items-center justify-center gap-1 text-[var(--text-tertiary)]">
            ...
            <p class="text-[10px] text-[var(--text-secondary)]">{t('cases')}</p>
          </div>
          <div class="rounded-[var(--radius-lg)] bg-[var(--surface-sunken)] p-2 text-center">
            <div class="flex items-center justify-center gap-1 text-[var(--text-tertiary)]">
            ...
            <p class="text-[10px] text-[var(--text-secondary)]">{t('tasks')}</p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-3 text-sm">
          <div>
            <p class="text-xs text-[var(--text-tertiary)]">{t('owner')}</p>
            <p class="font-medium text-[var(--text-primary)]">
              {selectedAccount.owner?.name || t('unassigned')}
            </p>
          </div>
          <div>
